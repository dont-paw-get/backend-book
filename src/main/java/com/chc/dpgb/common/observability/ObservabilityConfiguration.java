...
class ObservabilityConfiguration {
     ...
     * k8s readiness/liveness 프로브(`/health`, pod당 10~20초 간격)와 Swagger 문서 자산(`/docs`·`/webjars`·`/openapi.yaml`)은
     * 비즈니스 트래픽이 아닌데 자동 계측이 매 요청 span을 만들어, dev sampling 1.0에서 Tempo를 프로브 trace로 도배한다.
     * SecurityConfig의 permitAll 목록과 같은 경로다.
     */
    private static final List<String> UNOBSERVED_PATHS = List.of("/health", "/openapi.yaml", "/docs", "/webjars");
