...
public class LibraryBookService {
	...
	LibraryBookService(LibraryBookRepository libraryBookRepository, ShelfRepository shelfRepository,
	...
	@Transactional
	public LibraryBook createLibraryBook(String memberId, Long requestedShelfId, String title, String author,
		...
		LibraryBook book;
		try {
			book = LibraryBook.register(memberId, shelf.getShelfId(), shelfRank, title, author, isbn, publisher,
					publishedDate, coverUrl, totalPages);
	...
	public Page<LibraryBook> getLibraryBooks(String memberId, Long shelfId, String author, LibrarySortBy sortBy,
		...
		if (sortBy == LibrarySortBy.PROGRESS) {
			...
			return libraryBookRepository.findPageOrderByProgress(
					memberId, shelfId, author, direction == Sort.Direction.ASC, pageable);
		}
	...
	@Transactional
	public LibraryBook updateLibraryBook(String memberId, Long bookId, String title, String author, String isbn,
	...
	@Transactional
	public LibraryBook reorderLibraryBook(String memberId, Long bookId, Long beforeBookId, Long afterBookId) {
	...
	@Transactional
	public LibraryBook updateReadingProgress(String memberId, Long bookId, int currentPage, int totalPages) {
		LibraryBook book = getOwnedBook(memberId, bookId);
		try {
	...
	private LibraryBook getOwnedBook(String memberId, Long bookId) {
		LibraryBook book = libraryBookRepository.findById(bookId).orElseThrow(LibraryBookNotFoundException::new);
	...
	private String rankNextToWithRebalance(Long shelfId, Long movingBookId, Long neighborId, boolean placeBefore) {
