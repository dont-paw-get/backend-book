...
class LibraryBookServiceTest {
	...
	private void stubSaveToReturnItsArgument() {
		when(libraryBookRepository.save(any(LibraryBook.class))).thenAnswer(invocation -> invocation.getArgument(0));
	}

	private static LibraryBook book(Long bookId, String memberId, Long shelfId, String shelfRank) {
		LibraryBook book = LibraryBook.register(memberId, shelfId, shelfRank, "제목", "저자", null, null, null, null, 100);
